...
import com.techidea.weiboapp.entity.response.CommentsResponse;
...
public class StatusDetailActivity extends BaseActivity implements
    ...
    private void initListView(){
        ...
        //滚动状体监听
        plv_status_detail.setOnScrollListener(
    ...
    private void setData(){
        ...
        //bpttom_control - 底部互动栏，包括转发 评论 点赞
    ...
    private void loadComments(final long requestPage){
        weiboApi.commentShow(status.getId(), requestPage,
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int i) {
        //更新tab菜单栏某个选项时，注意header菜单栏和shadow菜单栏的选中状态同步
        switch(i){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //如果back键返回 取消发评论等情况 则直接return 不作后续处理
