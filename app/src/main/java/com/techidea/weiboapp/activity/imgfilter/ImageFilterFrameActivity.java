...
public class ImageFilterFrameActivity extends BaseActivity{
    ...
    private void setListener() {
        ...
        mFrame_1.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_2.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_3.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_4.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_5.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_6.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_7.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_8.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_9.setOnClickListener(new View.OnClickListener() {
        ...
        mFrame_10.setOnClickListener(new View.OnClickListener() {
...
//		mOldBitmap = mKXApplication.getPhoneAlbum(mPath);
    ...
    private void backDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(ImageFilterFrameActivity.this);
