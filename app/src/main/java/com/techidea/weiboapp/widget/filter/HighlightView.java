...
public class HighlightView {
    ...
    public void setFocus(boolean mIsFocused) {
        ...
        if(!hasFocus()){
            ...
            if(mCircle){
                ...
                path.addCircle(mDrawRect.left + (width/2),
                        mDrawRect.top + (height/2),width/2,Path.Direction.CW);
                ...
                if(mCircle){
                    ...
                    * (mDrawRect.width()/2D));
                    ...
                    mResizeDrawableDiagonal.setBounds(x,y,x+ mResizeDrawableDiagonal.getIntrinsicWidth(),
                            y + mResizeDrawableDiagonal.getIntrinsicWidth());
            ...
            if(mCircle){
                ...
                mResizeDrawableDiagonal2.setBounds(left-widthWidth,
                        top-widthHeight,left+ widthWidth,top + widthHeight);
                mResizeDrawableDiagonal2.draw(canvas);

                mResizeDrawableDiagonal.setBounds(right-widthWidth,
                        top - widthHeight,right + widthWidth,top +widthHeight );
                mResizeDrawableDiagonal.draw(canvas);

                mResizeDrawableDiagonal.setBounds(left-widthWidth,
                        bottom - widthHeight,left + widthWidth, bottom  + widthHeight);
                mResizeDrawableDiagonal.draw(canvas);
    ...
    public void handleMotion(int edge,float dx,float dy){
        ...
        if(edge == GROW_NONE){
            ...
            //Convert to image space before senfing to growBy()
    ...
    //Grows the cropping rectande by (dx,dy) in image space
    void moveBy(float dx,float dy){
        ...
        //Put the cropping rectandle inside image rectangle
